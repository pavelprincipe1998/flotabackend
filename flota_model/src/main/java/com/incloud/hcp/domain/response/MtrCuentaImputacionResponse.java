...
@ToString
@EqualsAndHashCode
public class MtrCuentaImputacionResponse extends BaseResponseDomain<MtrCuentaImputacion> {
    ...
    private String codigoCuentaImputacionCondicion;
    ...
    private List<String> codigoCuentaImputacionList;
