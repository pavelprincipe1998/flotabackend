...
public abstract class FacFacturaRest extends JPACustomRest<FacFacturaResponse, FacFactura, Integer> {
    ...
    */
    ...
    public ResponseEntity<Long> countByMtrEstado(@RequestBody @Valid MtrEstado mtrEstado, BindingResult bindingResult) throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.countByMtrEstado(mtrEstado)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByMtrEstado() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.graphByMtrEstado()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<Long> countByMtrMoneda(@RequestBody @Valid MtrMoneda mtrMoneda, BindingResult bindingResult) throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.countByMtrMoneda(mtrMoneda)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByMtrMoneda() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.graphByMtrMoneda()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    /**
    * Contador de registros para el atributo mtrDetraccion.
    */
    @ApiOperation(value = "Contador de registros para el atributo mtrDetraccion", produces = "application/json")
    @PostMapping(value = "/countByMtrDetraccion", produces = APPLICATION_JSON_VALUE)
    public ResponseEntity<Long> countByMtrDetraccion(@RequestBody @Valid MtrDetraccion mtrDetraccion, BindingResult bindingResult) throws URISyntaxException {
        BindingErrorsResponse errors = new BindingErrorsResponse();
        HttpHeaders headers = new HttpHeaders();
        if (bindingResult.hasErrors()) {
            errors.addAllErrors(bindingResult);
        ...
        log.debug("Ingresando countByMtrDetraccion");
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.countByMtrDetraccion(mtrDetraccion)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    /**
    * Genera Grafico de registros para el atributo mtrDetraccion.
    */
    @ApiOperation(value = "Genera Grafico de registros para el atributo mtrDetraccion", produces = "application/json")
    @GetMapping(value = "/graphByMtrDetraccion", produces = APPLICATION_JSON_VALUE)
    public ResponseEntity<GraphBean> graphByMtrDetraccion() throws URISyntaxException {
        log.debug("Ingresando graphByMtrDetraccion");
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.graphByMtrDetraccion()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<Long> countByMtrProveedor(@RequestBody @Valid MtrProveedor mtrProveedor, BindingResult bindingResult) throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.countByMtrProveedor(mtrProveedor)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByMtrProveedor() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.graphByMtrProveedor()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    /**
    * Contador de registros para el atributo facContacto.
    */
    @ApiOperation(value = "Contador de registros para el atributo facContacto", produces = "application/json")
    @PostMapping(value = "/countByFacContacto", produces = APPLICATION_JSON_VALUE)
    public ResponseEntity<Long> countByFacContacto(@RequestBody @Valid FacContacto facContacto, BindingResult bindingResult) throws URISyntaxException {
        BindingErrorsResponse errors = new BindingErrorsResponse();
        HttpHeaders headers = new HttpHeaders();
        if (bindingResult.hasErrors()) {
            errors.addAllErrors(bindingResult);
        ...
        log.debug("Ingresando countByFacContacto");
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.countByFacContacto(facContacto)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    /**
    * Genera Grafico de registros para el atributo facContacto.
    */
    @ApiOperation(value = "Genera Grafico de registros para el atributo facContacto", produces = "application/json")
    @GetMapping(value = "/graphByFacContacto", produces = APPLICATION_JSON_VALUE)
    public ResponseEntity<GraphBean> graphByFacContacto() throws URISyntaxException {
        log.debug("Ingresando graphByFacContacto");
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.graphByFacContacto()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
