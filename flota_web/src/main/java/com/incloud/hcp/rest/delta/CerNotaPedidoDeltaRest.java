...
public class CerNotaPedidoDeltaRest extends CerNotaPedidoRest {
    ...
    @GetMapping(value = "/_downloadExcelporFiltro/{nroPedido}/{ruc}/{razonSocial}/{userCompra}/{mtrSociedadId}/{fechaInicio}/{fechaFin}/{fechaDocumentoIni}/{fechaDocumentoFin}/{fechaFinVigenciaIni}/{fechaFinVigenciaFin}/{mtrEstadoId}", produces = { MediaType.APPLICATION_OCTET_STREAM_VALUE })
