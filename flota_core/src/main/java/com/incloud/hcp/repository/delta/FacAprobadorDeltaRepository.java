...
import com.incloud.hcp.repository.FacAprobadorRepository;

import java.util.List;

public interface FacAprobadorDeltaRepository extends FacAprobadorRepository {

    List<FacAprobador> findByFacFactura(FacFactura facFactura);
