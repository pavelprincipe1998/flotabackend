...
/**
 * Simple Interface for MtrEmbarcacion para Carga Masiva.
 */
public interface MtrEmbarcacionRequireNewService extends JPACustomRequiredNewService<MtrEmbarcacion> {
