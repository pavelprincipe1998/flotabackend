...
public abstract class MtrCuentaImputacionServiceImpl extends JPACustomServiceImpl<MtrCuentaImputacionResponse, MtrCuentaImputacion, Integer>
    ...
    protected String validacionesPreviasCreate(MtrCuentaImputacion bean) throws Exception {
        ...
        validar = this.mtrCuentaImputacionDeltaRepository.getByCodigoCuentaImputacion(bean.getCodigoCuentaImputacion());
        if (Optional.ofNullable(validar).isPresent()) {
            msg = this.messageSource.getMessage("message.mtrCuentaImputacion.codigoCuentaImputacion.duplicado", null, LocaleContextHolder.getLocale());
            return msg;
        }
        validar = this.mtrCuentaImputacionDeltaRepository.getByDescripcion(bean.getDescripcion());
        if (Optional.ofNullable(validar).isPresent()) {
            msg = this.messageSource.getMessage("message.mtrCuentaImputacion.descripcion.duplicado", null, LocaleContextHolder.getLocale());
            return msg;
        }
        return msg;
    }
